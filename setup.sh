...
wget -O /etc/nginx/conf.d/funnvpn.conf https://raw.githubusercontent.com/SETANTAZVPN/last/main/funnvpn.conf
...
rm -fr menu
rm -fr /usr/sbin/menu
wget https://raw.githubusercontent.com/SETANTAZVPN/last/main/funnyx.zip
unzip funnyx.zip
rm -fr funnyx.zip
chmod +x *
clear
cd /usr/local/bin
wget https://raw.githubusercontent.com/SETANTAZVPN/last/main/ws.zip
unzip ws.zip
rm -fr ws.zip
chmod +x *
chmod +x /usr/bin/*
cd /etc/systemd/system
wget https://raw.githubusercontent.com/SETANTAZVPN/last/main/service.zip
unzip service.zip
rm -fr service.zip
...
wget -O /etc/xray/config.json https://raw.githubusercontent.com/SETANTAZVPN/last/main/config.json
